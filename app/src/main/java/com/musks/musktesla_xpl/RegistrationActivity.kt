...
import com.musks.musktesla_xpl.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.wqvrbbr.setOnClickListener {
            ...
            binding.wqvrbbr.setBackgroundResource(R.drawable.bg_color_select)
            binding.wqvrbbr.isEnabled = false

            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"60b61dd93f1f950026a86f9f",ed2stName,ed_tel,"bjhhgdxstr")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.wqvrbbr.setBackgroundResource(R.drawable.bg_selector)
                                binding.wqvrbbr.isEnabled = true
                            }
